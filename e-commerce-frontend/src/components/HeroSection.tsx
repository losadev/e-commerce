...
const HeroSection = () => {
  return (
    ...
    <section className="text-center py-10 flex flex-col gap-3">
      ...
      <button className="hover:cursor-pointer bg-white/20 inline-flex text-white text-center w-fit mt-4 m-auto py-1.5 px-8 border-2 border-gray-200 font-bold text-[.9rem] drop-shadow-[2px_2px_2px_black] hover:bg-white/40"><a href="#products">Shop now</a></button>
    </section>
    </div>
  )
}
